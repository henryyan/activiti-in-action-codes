        ...
        $(function() {
            $('.change-retries').click(function() {
                ...
                if (isNaN(retries)) {
                    ...
                    location.href = ctx + '/chapter14/job/change/retries/' + $(this).data('jobid') + "?retries=" + retries;
                }
            });
        });
    </script>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" style="min-width: 100px;margin-left: -70px;">
                        <li><a href="execute/${job.id}"><i class="glyphicon glyphicon-play"></i>执行</a></li>
                        <li><a href="delete/${job.id}"><i class="glyphicon glyphicon-trash"></i>删除</a></li>
                        <li><a href="#" title="更改执行次数" data-jobid="${job.id}" class="change-retries"><i class="glyphicon glyphicon-wrench"></i>执行次数</a></li>
                    </ul>
                </div>
            </td>
        </tr>
