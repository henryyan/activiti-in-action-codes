...
<body>
			...
			<tr>
				...
				<th>操作
					<a href="#newTaskModal" data-toggle="modal" class="btn btn-primary btn-small" style="float:right;">
						<i class="glyphicon glyphicon-plus"></i>新任务</a>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					...
					<td>
						<c:if test="${empty task.assignee }">
							<a class="btn btn-primary" href="claim/${task.id}"><i class="glyphicon glyphicon-ok"></i>签收</a>
							<a class="btn" href="getform/${task.id}"><i class="glyphicon glyphicon-eye-open"></i>查看</a>
						</c:if>
						<c:if test="${not empty task.assignee }">
							<a class="btn btn-primary" href="getform/${task.id}"><i class="glyphicon glyphicon-user"></i>办理</a>
							<a class="btn" href="unclaim/${task.id}"><i class="glyphicon glyphicon-remove"></i>反签收</a>
						</c:if>
					</td>
				</tr>
			</c:forEach>
	...
	<!-- 添加子任务对话框 -->
	<div id="newTaskModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="newTaskModalLabel" aria-hidden="true">
            ...
            <div class="modal-content" style="padding-bottom: 2em;">
              ...
              <div class="modal-body">
                <form id="newTaskForm" action="${ctx}/chapter6/task/new" class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="description">任务描述:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="dueDate">到期日:</label>
                        <div class="col-sm-6">
                            <input type="text" name="dueDate" data-date-format="yyyy-mm-dd" class="form-control datepicker required" />
                        </div>
                    </div>
