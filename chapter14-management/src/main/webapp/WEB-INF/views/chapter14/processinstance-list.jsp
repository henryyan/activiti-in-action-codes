        ...
        <tr>
            ...
            <td>
                ...
                <c:if test="${pi.suspended}">
                    <a class="btn btn-small state-btn" href="${ctx }/chapter14/processinstance/active/${pi.id}"><i class="icon-ok"></i>激活</a>
                </c:if>
                <c:if test="${!pi.suspended}">
                    <a class="btn btn-small state-btn" href="${ctx }/chapter14/processinstance/suspend/${pi.id}"><i class="icon-lock"></i>挂起</a>
                </c:if>
            </td>
            <td>
