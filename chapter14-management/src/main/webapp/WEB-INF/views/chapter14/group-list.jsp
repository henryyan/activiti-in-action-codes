...
<ul class="nav nav-pills">
    <li><a href="${ctx}/chapter14/identity/user/list"><i class="icon-user"></i>用户管理</a></li>
    <li class="active"><a href="${ctx}/chapter14/identity/group/list"><i class="icon-list"></i>组管理</a></li>
</ul>
<hr>
            ...
            <table width="100%" class="table table-bordered table-hover table-condensed">
                ...
                <c:forEach items="${page.result }" var="group">
                    <tr id="${group.id}">
                        ...
                        <td>
                            <a class="btn btn-danger btn-small" href="${ctx}/chapter14/identity/group/delete/${group.id}"><i class="icon-remove"></i>删除</a>
